...
<head>
    ...
    <style>
        ...
        th {
            background-color:rgb(143, 88, 210);
            font-weight: bold;
        }
        tr:nth-child(even) {
            background-color:rgb(204, 180, 234);
        }
        .title {
            text-align: center;
            font-size: 20px;
                ...
                <tbody>
                    <?php while ($row = $result->fetch_assoc()): ?>
                        <tr>
                            ...
                            <td>
                                <a href="update.php?matric=<?= urlencode($row['matric']) ?>" class="btn btn-update">Update</a>
